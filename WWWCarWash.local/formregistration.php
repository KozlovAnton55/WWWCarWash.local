...
<head>
    ...
    <title>Регистрация | WWW Car Wash</title>
    ...
    <header>
        <div class="headWrapper">
            ...
            <div class="autentification">
                <div class="but">
                    <a href="./formauthorisation.php"><button>Авторизоваться</button></a>
                </div>
            </div>
    ...
    <main>
        ...
        <div class="formreg">
            <form action="registration.php" method="post">
                ...
                <input type="text" name="login" id="login" required minlength="3" maxlength="255"><br>
